...
> Papyrus Desktop **v2.0.0-beta.15** — TypeScript / Fastify backend, React 19 frontend, Electron 41 desktop shell.

![Version](https://img.shields.io/badge/version-v2.0.0--beta.15-blue)
...
> ⚠️ `v2.0.0-beta.15` is a beta. The data schema is stable, but the UI and APIs may still evolve before `v2.0.0`.
